...
namespace Outils
{
	/** Convertir en std::string tous types supportant l'opérateur de flux <<
	 *
	 * @param aConvertir La données à convertir
	 * @return La chaîne de caractères qui correspond
	 */
	template<typename T>
	...
	/** Remplace les caractères interdits dans les noms de fichiers ou dans la console par des tirets "-" <br>
