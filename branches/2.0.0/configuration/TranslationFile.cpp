...
TranslationFile::TranslationFile(const string & filePath) throw(ConfigurationFileException,TranslationException)
...
string TranslationFile::operator [](const string & keyword) throw (TranslationException)
{
	if (keywordExists(keyword))
		...
		throw TranslationException(keyword + " does not correspond to a known translation in the file " + filePath);
}
