...
/** Classe définissant un objet incopiable par défaut */
template <class B = BaseVide>
class Incopiable : B
{
private:
	// Empêche la copie, aucun corps ne sera donné à ces opérateurs
	Incopiable(const Incopiable &); // Un constructeur par défaut devra être implémenté chez les enfants
