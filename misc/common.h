...
#ifdef _LINUX // Under Linux (or just gcc 4.1.3?), these headers are required to make
              // <string>/<sstream> working (e.g. for std::min/max declarations)
#include <vector>
#include <fstream>
#endif // _LINUX
...
#define CSSMATCH_PLUGIN_PRINT_BASE "2.2.5"
#ifdef CSSMATCH_BETA
...
namespace cssmatch
{
     ...
     * @return <code>true</code> if the player pointer is valid, or <code>false</code> if the player
     * is invalid or SourceTV
     */
     ...
     * @return <code>true</code> if the base combat character pointer is valid, <code>false</code> 
     * otherwise
     */
     ...
     * @return The server entity pointer corresponding to this entity, or NULL if something was 
     * invalid
     */
     ...
     * @param entity The entity
     * @return The base player entity pointer corresponding to this entity, or NULL if something 
     * was invalid
     */
     ...
     * @param entity The entity
     * @return The server unknown pointer corresponding to this entity, or NULL if something was 
     * invalid
     */
