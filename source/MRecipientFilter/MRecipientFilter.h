 ...
 *
 * @author http://www.hl2coding.com (l'auteur précis m'est inconnu)
 *
 */
...
public:
	/** Prépare une liste de destinataires vide */
	MRecipientFilter();

	/** Détruit la liste de destinataires */
	~MRecipientFilter();
	...
	/** Ajoute tous les joueurs à la liste */
	void addAllPlayers();
	...
	/** Récupère l'index du joueur situé à une position de la liste de destinataire
	 *
