...
public:
	...
	/** Lance un Decompte d'une certaine durée (en secondes) <br>
	 * Une fonction prenant un paramètre pourra être exécutée en fin de décompte
	 */
	...
	/** Retourne le temps restant (en secondes) du décompte */
	int getTempsRestant();
