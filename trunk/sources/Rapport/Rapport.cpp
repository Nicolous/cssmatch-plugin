...
Rapport::Rapport(Match * match)
{
	...
	string nomFichier(string(datebuf) + "_" + Api::gpGlobals->mapname.ToCStr());

	// Construction du nom final du fichier avec son arborescence (sans l'extention)
	nom = "cstrike/cfg/cssmatch/rapports/" + nomFichier;
...
void Rapport::trouveLignups()
{
	...
	int appMaxParTeam = Api::maxplayers/2;
