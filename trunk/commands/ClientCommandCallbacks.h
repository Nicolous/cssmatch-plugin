...
namespace cssmatch
{
	...
	PLUGIN_RESULT clientcmd_jointeam(ClanMember * user, const CCommand & args); // jointeam restriction in match
	PLUGIN_RESULT clientcmd_menuselect(ClanMember * user, const CCommand & args); // menu actions

	PLUGIN_RESULT clientcmd_cssmatch(ClanMember * user, const CCommand & args); // cssmatch menu

	PLUGIN_RESULT clientcmd_rates(ClanMember * user, const CCommand & args); // show players rates
}
